...
<div class="auth-page-wrapper">
    <div class="auth-card">
        ...
        <h2 class="auth-title mb-2">{{ __('تفعيل الحساب') }}</h2>
        <p class="auth-subtitle">
            {{ __('لقد أرسلنا كود التحقق إلى البريد الإلكتروني:') }}<br>
            <span class="email-highlight">{{ $email }}</span>
        </p>

        @if ($errors->any())
            <div class="alert-auth alert-auth-error mb-4">
        ...
        @if (session('success'))
            <div class="alert alert-success mb-4" style="border-radius: 10px; font-size: .9rem;">
                {{ session('success') }}
            </div>
        @endif
        ...
        <div class="mt-4">
            <a href="{{ route('register') }}" style="font-size: .9rem; color: #6b7280; text-decoration: none;">
