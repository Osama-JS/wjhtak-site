...
<div class="cdash-wrapper">
    ...
    <aside class="cdash-sidebar" id="cdashSidebar">
        ...
        <div class="cdash-sidebar-user">
            ...
            <div class="user-info">
                ...
                <div class="user-type">{{ __('Subscriber') }}</div>
            </div>
        </div>
        ...
        <nav class="cdash-nav">
            ...
            <div class="cdash-nav-item">
                <a href="{{ route('customer.favorites.index') }}" class="{{ request()->routeIs('customer.favorites.*') ? 'active' : '' }}">
                    <i class="fas fa-heart"></i>
                    <span>{{ __('Favorites') }}</span>
                </a>
            </div>

            <div class="cdash-nav-label">{{ __('Account') }}</div>
    ...
    <main class="cdash-main">
        ...
        <div class="cdash-content">
            ...
            @endif
            @if(session('info'))
                <div class="cdash-flash cdash-flash-info">
